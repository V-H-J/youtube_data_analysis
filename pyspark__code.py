...
## type: DataSource , args: [database = "db_youtube_raw", table_name = "raw_statistics", transformation_ctx = "datasource0"]
# return: datasource0, inputs: []
...
## type: ResolveChoice, args: [choice = "make_struct", transformation_ctx = "resolvechoice2"]
## return: resolvechoice2, inputs: [frame = applymapping1]
resolvechoice2 = ResolveChoice.apply(frame = applymapping1, choice = "make_struct", transformation_ctx = "resolvechoice2")

## @type: DropNullFields, @args: [transformation_ctx = "dropnullfields3"], @return: dropnullfields3, @inputs: [frame = resolvechoice2]
dropnullfields3 = DropNullFields.apply(frame = resolvechoice2, transformation_ctx = "dropnullfields3")

## type: DataSink, args: [connection_type = "s3", connection_options = {"path": "s3://bigdata-on-youtube-cleansed-euwest1-14317621-dev/youtube/raw_statistics/"}, format = "parquet", transformation_ctx = "datasink4"]
## return: datasink4, inputs: [frame = dropnullfields3]
